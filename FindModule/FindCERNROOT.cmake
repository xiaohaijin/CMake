...
set(_root_options  asimage astiff builtin_afterimage builtin_ftgl builtin_gl2ps builtin_glew builtin_llvm builtin_clang builtin_lz4 builtin_tbb builtin_unuran builtin_xxhash cling cxx11 exceptions explicitlink gdml genvector http imt mysql opengl pch pgsql python roofit shared sqlite ssl thread tmva x11 xft xml)
...
if(ROOT_INCLUDE_DIRS AND ROOT_LIBRARIES)
  set(CERNROOT_FOUND TRUE)
endif(ROOT_INCLUDE_DIRS AND ROOT_LIBRARIES)
